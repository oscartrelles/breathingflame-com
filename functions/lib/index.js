...
exports.submitContactForm = functions.https.onRequest((req, res) => {
    return corsHandler(req, res, async () => {
        ...
        ${(interests === null || interests === void 0 ? void 0 : interests.length) ? `Interests: ${interests.join(', ')}` : ''}
      ...
      `;
            await emailTransporter.sendMail({
                from: (_a = functions.config().email) === null || _a === void 0 ? void 0 : _a.user,
                to: (_b = functions.config().email) === null || _b === void 0 ? void 0 : _b.recipient,
      ...
      `;
            await emailTransporter.sendMail({
                from: (_c = functions.config().email) === null || _c === void 0 ? void 0 : _c.user,
                to: email,
...
exports.newsletterSignup = functions.https.onRequest((req, res) => {
    return corsHandler(req, res, async () => {
        var _a;
        if (req.method !== 'POST') {
            return res.status(405).json({ error: 'Method not allowed' });
...
exports.cleanupAnalytics = functions.pubsub.schedule('0 2 * * 0').onRun(async (_context) => {
